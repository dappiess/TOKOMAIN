...
<html>
<head>
<title>DREAM STORE - Checkout</title>
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="keywords" content="DREAM STORE" />
...
<body>
	...
	<div class="checkout">
		<div class="container">
			<h1>Terima kasih, <?=$_SESSION['name']?> telah membeli <?php echo $itungtrans3 ?> barang di Dream Store</span></h1>
...
<div class="footer">
			...
			<div class="w3_footer_grids">
				<div class="col-md-4 w3_footer_grid">
					...
					<ul class="address">
						...
						<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a href="mailto:info@email">dreamstoremlg@gmaul.com</a></li>
						<li><i class="glyphicon glyphicon-earphone" aria-hidden="true"></i>+62 8970 674</li>
					</ul>
				</div>
		...
		<div class="footer-copy">
			<div class="container">
				<p>© DREAM STORE, . All rights reserved</p>
			</div>
		</div>
	</div>	
